...
function getPasswordStrength(password: string): { label: string; width: string; color: string } {
  if (password.length < 4) return { label: '', width: '0%', color: '#E5E7EB' }
  if (password.length < 8)
    return { label: 'Débil', width: '33%', color: '#F59E0B' }
  if (!/[A-Z]/.test(password) || !/[0-9]/.test(password))
    return { label: 'Regular', width: '66%', color: '#F59E0B' }
  return { label: 'Fuerte', width: '100%', color: '#10B981' }
}
        ...
        <div className="grid grid-cols-1 gap-0 rounded-3xl bg-white shadow-xl ring-1 ring-black/5 md:grid-cols-2 md:gap-8 lg:gap-12">
          ...
          <div className="relative flex flex-col items-center justify-center gap-8 bg-gradient-to-br from-[#1F4E79] via-[#173A5C] to-[#0F2A44] px-8 py-12 text-center text-white">
            ...
            <div className="relative z-10">
              ...
              <h2 className="mb-4 text-2xl font-semibold">Crea tu cuenta</h2>
              <p className="mx-auto max-w-xs text-sm text-blue-100">
                Regístrate para descubrir el estilo de trabajo de tu equipo.
              </p>
            </div>
  ...
  return (
    ...
    >
      ...
      <path
        ...
        strokeLinejoin="round"
        strokeWidth={2}
        d="M9.878 9.878A3 3 0 1 1 14.12 14.12M9.878 9.878L6.5 6.5M17.5 17.5L14.12 14.12"
      />
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
