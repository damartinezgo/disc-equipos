        ...
        <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3">
          ...
          <div className="flex items-center gap-4">
            <button
              ...
              className="text-sm font-medium text-gray-600 cursor-pointer transition hover:text-[#1F4E79]"
            >
              Instrucciones
            </button>
            <button
              ...
              className="text-sm font-medium text-[#1F4E79] cursor-pointer underline underline-offset-2 hover:text-[#173A5C]"
            >
